...
**Companion files:**
  ...
  - [`v1_4_3_META_SETUP.md`](./v1_4_3_02_PREP_META_SETUP.md) — Step-by-step Meta Business Page + Pixel + Conversions API setup
  - [`v1_4_3_SHIPPO_REPLY.md`](./v1_4_3_02_PREP_SHIPPO_REPLY.md) — Drafted reply to Shippo Trust & Safety verification email
...
- [ ] **USPS account + Shippo linking** — deferred to v1.1+ when label volume justifies; v1 uses Shippo's free Starter UI. Reply to Shippo Trust & Safety queued in [`v1_4_3_SHIPPO_REPLY.md`](./v1_4_3_02_PREP_SHIPPO_REPLY.md).
- [ ] **Meta Business assets + tokens** — `META_ACCESS_TOKEN` + `META_PIXEL_ID` not yet generated. Step-by-step setup guide produced as [`v1_4_3_META_SETUP.md`](./v1_4_3_02_PREP_META_SETUP.md). Sean to execute when convenient; Tracks A/B can proceed without these (placeholder env vars OK during dev).
