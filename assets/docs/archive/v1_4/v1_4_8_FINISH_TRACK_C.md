# v1.4.8 — Finish Track C (BUILD packet)
...
// Pre-existing mark-sold write — UNCHANGED in v1.4.8; this is exactly what Phase 8.4 verifies:
...
| IMPLEMENT item                              | Status in v1.4.8                                                                                              |
| ------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
...
- Supabase schema changes via the Supabase CLI, not MCP. (No schema changes needed in v1.4.8.)
