...
## Related Documentation
  ...
  - **Current build guide (v4.0 as-built)**: `assets/docs/archive/v4_0/v4_0_0_IMPLEMENT.md` + `v4_0_0_ADDENDUM_{DESIGN,TESTING}.md` + `v4_0_0_BUILD_REPORT.md` + `_RATIONALE.md` (the `archive/v3_3/` + `archive/v2_0/` packets are its base; prior waves kept for history). Shipped GPT files: `v4_0_7_GPT_SCHEMA.txt` + `v4_0_7_GPT_INSTRUCTIONS_TRIMMED.txt`
