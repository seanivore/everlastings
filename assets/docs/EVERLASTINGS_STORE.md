...
**Build Guide** (current, exclusively-executable):
  ...
  - `assets/docs/archive/v1_5/v1_5_0_IMPLEMENT.md` — **next**: AI store-management (GPT edit + draft/preview/publish + coupons + admin unify) then design; architecture spec, executable build doc to follow
